...
public class Attendance {
	...
	public Attendance(Integer attendance_id, Integer gridStaffId, String recordDate, Date start_time, String start_site,
			String start_memo, Date end_time, String end_site, String end_memo, String attendance_pic,
			Grid_staff gridStaff) {
		super();
	...
	public String toString() {
		return "Attendance [attendance_id=" + attendance_id + ", gridStaffId=" + gridStaffId + ", recordDate="
				+ recordDate + ", start_time=" + start_time + ", start_site=" + start_site + ", start_memo="
				+ start_memo + ", end_time=" + end_time + ", end_site=" + end_site + ", end_memo=" + end_memo
				+ ", attendance_pic=" + attendance_pic + ", gridStaff=" + gridStaff + "]";
	}
